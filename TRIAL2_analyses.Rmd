...
m.new.shoots <- aov(shoot.production ~ site * infection + mesocosm, data = filter(mesocosm.shoot, vase != 17 & vase != 21 & vase != 27 & vase != 29 & vase != 37 & vase != 47 & vase != 59 & vase != 81))
Anova(m.new.shoots)
...
m.new.leaves <- aov(no.leaves.new.final ~ site*infection + mesocosm + no.leaves.initial, data = filter(mesocosm.shoot, vase != 17 & vase != 21 & vase != 27 & vase != 29 & vase != 37 & vase != 47 & vase != 59 & vase != 81))
...
m.lost.leaves <- aov(no.leaves.lost.final ~ site*infection + mesocosm + no.leaves.initial, data = filter(mesocosm.shoot,vase != 17 & vase != 21 & vase != 27 & vase != 29 & vase != 37 & vase != 47 & vase != 59 & vase != 81))
...
##leaf growth
```{r eval = FALSE, echo = FALSE}
p <- ggplot(filter(mesocosm.growth, vase != 17 & vase != 21 & vase != 27 & vase != 29 & vase != 37 & vase != 47 & vase != 59 & vase != 81), aes(x = site, y = leaf1.growth)) + 
  #scale_fill_manual(values = c("white", "gray")) +
  geom_violin(position = position_dodge(1)) +
  geom_dotplot(binaxis = 'y', stackdir = 'center', position = position_dodge(1), dotsize  = 0.5) +
  stat_summary(fun.y = mean, geom = "point", size = 3, color = "red", position = position_dodge(1)) +
...
m.leaf1.growth <- aov(leaf1.growth ~ site*infection + mesocosm + initial.length.cm, data = filter(mesocosm.growth, vase != 17 & vase != 21 & vase != 27 & vase != 29 & vase != 37 & vase != 47 & vase != 59 & vase != 81))
...
m.ag.biomass <- aov(ag.biomass.final ~ site*infection + mesocosm, data = filter(mesocosm.shoot,vase != 17 & vase != 21 & vase != 27 & vase != 29 & vase != 37 & vase != 47 & vase != 59 & vase != 81))
...
m.bg.biomass <- aov(bg.biomass.final ~ site*infection + mesocosm, data = filter(mesocosm.shoot,vase != 17 & vase != 21 & vase != 27 & vase != 29 & vase != 37 & vase != 47 & vase != 59 & vase != 81))
...
m.rhizome.growth <- aov(rhizome.growth ~ site*infection + mesocosm, data = filter(mesocosm.shoot, vase != 17 & vase != 21 & vase != 27 & vase != 29 & vase != 37 & vase != 47 & vase != 59 & vase != 81))
...
SA.data.master.ms <- SA.data.master %>%
  group_by(site) %>%
  summarize(ms.mean = mean(ms, na.rm = T), ms.se = se(ms, na.rm = T), ms.sd = sd(ms, na.rm = T))
...
SA.data.master.beta <- SA.data.master %>%
  group_by(site) %>%
  summarize(beta.mean = mean(beta, na.rm = T), beta.se = se(beta, na.rm = T), beta.sd = sd(beta, na.rm = T))
